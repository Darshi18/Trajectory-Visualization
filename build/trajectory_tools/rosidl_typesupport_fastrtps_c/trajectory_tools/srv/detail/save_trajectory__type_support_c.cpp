...
#include "trajectory_tools/srv/detail/save_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "trajectory_tools/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SaveTrajectory_Request__ros_msg_type = trajectory_tools__srv__SaveTrajectory_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_trajectory_tools
size_t get_serialized_size_trajectory_tools__srv__SaveTrajectory_Request(
  const void * untyped_ros_message,
...
static uint32_t _SaveTrajectory_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_trajectory_tools__srv__SaveTrajectory_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_trajectory_tools
size_t max_serialized_size_trajectory_tools__srv__SaveTrajectory_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = trajectory_tools__srv__SaveTrajectory_Request;
    is_plain =
      (
...
static size_t _SaveTrajectory_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_trajectory_tools__srv__SaveTrajectory_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trajectory_tools, srv, SaveTrajectory_Request)() {
...
using _SaveTrajectory_Response__ros_msg_type = trajectory_tools__srv__SaveTrajectory_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_trajectory_tools
size_t get_serialized_size_trajectory_tools__srv__SaveTrajectory_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SaveTrajectory_Response__ros_msg_type * ros_message = static_cast<const _SaveTrajectory_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_trajectory_tools__srv__SaveTrajectory_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_trajectory_tools
size_t max_serialized_size_trajectory_tools__srv__SaveTrajectory_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = trajectory_tools__srv__SaveTrajectory_Response;
    is_plain =
      (
...
static size_t _SaveTrajectory_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_trajectory_tools__srv__SaveTrajectory_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trajectory_tools, srv, SaveTrajectory_Response)() {
...
// already included above
// #include "trajectory_tools/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "trajectory_tools/srv/save_trajectory.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trajectory_tools, srv, SaveTrajectory)() {
