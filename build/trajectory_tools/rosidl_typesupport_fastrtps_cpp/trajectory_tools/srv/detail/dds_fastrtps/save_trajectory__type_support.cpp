...
#include "trajectory_tools/srv/detail/save_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_trajectory_tools
cdr_serialize(
  const trajectory_tools::srv::SaveTrajectory_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  trajectory_tools::srv::SaveTrajectory_Request & ros_message)
{
  // Member: filename
  cdr >> ros_message.filename;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = trajectory_tools::srv::SaveTrajectory_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const trajectory_tools::srv::SaveTrajectory_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<trajectory_tools::srv::SaveTrajectory_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_trajectory_tools
const rosidl_message_type_support_t *
get_message_type_support_handle<trajectory_tools::srv::SaveTrajectory_Request>()
{
  return &trajectory_tools::srv::typesupport_fastrtps_cpp::_SaveTrajectory_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trajectory_tools, srv, SaveTrajectory_Request)() {
  return &trajectory_tools::srv::typesupport_fastrtps_cpp::_SaveTrajectory_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_trajectory_tools
cdr_serialize(
  const trajectory_tools::srv::SaveTrajectory_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  trajectory_tools::srv::SaveTrajectory_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = trajectory_tools::srv::SaveTrajectory_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const trajectory_tools::srv::SaveTrajectory_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<trajectory_tools::srv::SaveTrajectory_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &trajectory_tools::srv::typesupport_fastrtps_cpp::_SaveTrajectory_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trajectory_tools, srv, SaveTrajectory_Response)() {
  return &trajectory_tools::srv::typesupport_fastrtps_cpp::_SaveTrajectory_Response__handle;
}
...
{
  return &trajectory_tools::srv::typesupport_fastrtps_cpp::_SaveTrajectory__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trajectory_tools, srv, SaveTrajectory)() {
  return &trajectory_tools::srv::typesupport_fastrtps_cpp::_SaveTrajectory__handle;
}
