...
class Metaclass_SaveTrajectory_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('trajectory_tools')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SaveTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'trajectory_tools.srv.SaveTrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from trajectory_tools.srv import _save_trajectory
...
class SaveTrajectory(metaclass=Metaclass_SaveTrajectory):
    from trajectory_tools.srv._save_trajectory import SaveTrajectory_Request as Request
    from trajectory_tools.srv._save_trajectory import SaveTrajectory_Response as Response
